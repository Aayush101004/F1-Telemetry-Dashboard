...
export default function DetailedBreakdown({ session, state, scopeIndex }: Props) {
    ...
    return (
        <div className="bg-slate-900/40 border border-slate-800/60 rounded-xl p-5 shadow-lg mb-8 overflow-hidden flex flex-col">
            <div className="flex items-center gap-3 mb-6 border-b border-slate-800/80 pb-3">
                ...
                <span className="text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full border bg-slate-900 text-slate-500 border-slate-800">
                    Telemetry Log
                </span>
            </div>
